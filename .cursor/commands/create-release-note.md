...
- 日本語出力では、英単語・オプション名と日本語の間にスペースを入れない。
  - NG: `--vpp-nnedi` に planes 指定を追加。
  - OK: `--vpp-nnedi`にplanes指定を追加。
  - NG: `--vpp-onnx` に SDR to HDR モデル対応を追加。
  - OK: `--vpp-onnx`にSDR to HDRモデル対応を追加。
  - 例外: 英語句内部のスペースはそのまま (`SDR to HDR`, `Phase 2`)
...
- 収集した内容に基づき下記4点の記述を行う。
  ...
  　　例: [--vpp-afs](./NVEncC_Options.en.md#--vpp-afs-param1value1param2value2)
    - githubのissue (#xxx)が含まれる変更は下記のように記載する
      例: Fix ~ error in [--vpp-afs](./NVEncC_Options.en.md#--vpp-afs-param1value1param2value2). ( #xxx )
  ...
  - ブログに記載する文章例を作成する。
    ...
    - githubのissue (#xxx)が含まれる変更は下記のように記載する
      ...
      <a class=blue href="https://github.com/rigaya/NVEnc/issues/xxx" target="_blank" title="ご指摘いただいた問題">ご指摘いただいた問題</a>の修正。
      ```
      例2
      ```
      <strong>- --vpp-afsに～を追加。</strong>
      <a class=blue href="https://github.com/rigaya/NVEnc/issues/xxx" target="_blank" title="ご要望いただいた機能">ご要望いただいた機能</a>の追加。
      ```
